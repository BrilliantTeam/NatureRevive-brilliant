...
public class NMSHandler1_21 implements INMSWrapper {
    ...
    public Object captureRegenerationContext(World world, int chunkX, int chunkZ) {
        return InPlaceRegeneration1_21.capture(((CraftWorld) world).getHandle(), chunkX, chunkZ);
    }

    @Override
    @SuppressWarnings("unchecked")
    public Object prepareRegeneratedChunk(World world, int chunkX, int chunkZ, Object context) {
        return InPlaceRegeneration1_21.prepare(((CraftWorld) world).getHandle(), chunkX, chunkZ,
                (Map<Long, InPlaceRegeneration1_21.Structures>) context);
    }

    @Override
    public void applyRegeneratedChunk(World world, int chunkX, int chunkZ, Object prepared, boolean regenerateEntities) {
        InPlaceRegeneration1_21.apply(((CraftWorld) world).getHandle(), chunkX, chunkZ, (ProtoChunk) prepared,

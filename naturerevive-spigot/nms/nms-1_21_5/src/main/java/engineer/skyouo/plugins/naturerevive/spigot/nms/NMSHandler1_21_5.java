...
public class NMSHandler1_21_5 implements INMSWrapper {
    ...
    public Object captureRegenerationContext(World world, int chunkX, int chunkZ) {
        return InPlaceRegeneration1_21_5.capture(((CraftWorld) world).getHandle(), chunkX, chunkZ);
    }

    @Override
    @SuppressWarnings("unchecked")
    public Object prepareRegeneratedChunk(World world, int chunkX, int chunkZ, Object context) {
        return InPlaceRegeneration1_21_5.prepare(((CraftWorld) world).getHandle(), chunkX, chunkZ,
                (Map<Long, InPlaceRegeneration1_21_5.Structures>) context);
    }

    @Override
    public void applyRegeneratedChunk(World world, int chunkX, int chunkZ, Object prepared) {
        InPlaceRegeneration1_21_5.apply(((CraftWorld) world).getHandle(), chunkX, chunkZ, (ProtoChunk) prepared,

...
public class NMSHandler1_21_3 implements INMSWrapper {
    ...
    public Object captureRegenerationContext(World world, int chunkX, int chunkZ) {
        return InPlaceRegeneration1_21_3.capture(((CraftWorld) world).getHandle(), chunkX, chunkZ);
    }

    @Override
    @SuppressWarnings("unchecked")
    public Object prepareRegeneratedChunk(World world, int chunkX, int chunkZ, Object context) {
        return InPlaceRegeneration1_21_3.prepare(((CraftWorld) world).getHandle(), chunkX, chunkZ,
                (Map<Long, InPlaceRegeneration1_21_3.Structures>) context);
    }

    @Override
    public void applyRegeneratedChunk(World world, int chunkX, int chunkZ, Object prepared) {
        InPlaceRegeneration1_21_3.apply(((CraftWorld) world).getHandle(), chunkX, chunkZ, (ProtoChunk) prepared,
